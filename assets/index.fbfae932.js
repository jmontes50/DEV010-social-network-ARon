...
class UserImpl {
  ...
  _clone(auth2) {
    const newUser2 = new UserImpl(Object.assign(Object.assign({}, this), { auth: auth2, stsTokenManager: this.stsTokenManager._clone() }));
    newUser2.metadata._copy(this.metadata);
    return newUser2;
  }
  _onReload(callback) {
...
class __PRIVATE_QueryImpl {
  constructor(e, t = null, n = [], r2 = [], i = null, s = "F", o = null, _ = null) {
    this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r2, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.he = null, this.Pe = null, this.Ie = null, this.startAt, this.endAt;
  }
}
...
class __PRIVATE_WatchChangeAggregator {
  constructor(e) {
    this.ke = e, this.qe = /* @__PURE__ */ new Map(), this.Qe = __PRIVATE_mutableDocumentMap(), this.Ke = __PRIVATE_documentTargetMap(), this.$e = new SortedMap(__PRIVATE_primitiveComparator);
  }
  Ue(e) {
    for (const t of e.me)
    ...
    this.forEachTarget(e, (t) => {
      ...
      switch (e.state) {
        case 0:
          ...
          break;
        case 1:
          n.Be(), n.De || n.Me(), n.ve(e.resumeToken);
          break;
        case 2:
        ...
        case 3:
          ...
          break;
        case 4:
          this.He(t) && (this.Je(t), n.ve(e.resumeToken));
          break;
        default:
          fail();
      }
  ...
  it(e, t) {
    ...
    return n.forEach((n2) => {
      ...
      e.mightContain(s) || (this.Ge(t, n2, null), r2++);
    }), r2;
  }
  st(e) {
    const t = /* @__PURE__ */ new Map();
  ...
  Ge(e, t, n) {
    if (!this.He(e))
      return;
    const r2 = this.je(e);
    this.ot(e, t) ? r2.xe(t, 1) : r2.Oe(t), this.Ke = this.Ke.insert(t, this._t(t).delete(e)), n && (this.Qe = this.Qe.insert(t, n));
  }
  removeTarget(e) {
    this.qe.delete(e);
  }
...
class __PRIVATE_MemoryMutationQueue {
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return this.wr.forEachWhile((e2) => {
      ...
      return !!n.isPrefixOf(t2) && (t2.length === r2 && (o = o.add(e2.pr)), true);
...
class __PRIVATE_MemoryTargetCache {
  constructor(e) {
    this.persistence = e, this.Mr = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.Or = 0, this.Nr = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.Br = __PRIVATE_TargetIdGenerator.Nn();
  }
  forEachTarget(e, t) {
...
class __PRIVATE_QueryEngine {
  constructor() {
    this.$i = false, this.Ui = false, this.Wi = 100, this.Gi = 8;
  }
  initialize(e, t) {
  ...
  es(e, t, n, r2) {
    return this.zi.getDocumentsMatchingQuery(e, n, r2).next((e2) => (t.forEach((t2) => {
...
class __PRIVATE_LocalStoreImpl {
  constructor(e, t, n, r2) {
    this.persistence = e, this.ts = t, this.serializer = r2, this.ns = new SortedMap(__PRIVATE_primitiveComparator), this.rs = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.ss = /* @__PURE__ */ new Map(), this.os = e.getRemoteDocumentCache(), this.Qr = e.getTargetCache(), this.$r = e.getBundleCache(), this._s(n);
  }
  _s(e) {
...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
  ...
  Fo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logWarn(Ve, `RPC '${e}' stream ${r2} transport errored:`, t2), P2.Vo(new FirestoreError(D.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = D.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.Vo(new FirestoreError(n3, i3)), c.close();
        } else
...
class __PRIVATE_PersistentStream {
  constructor(e, t, n, r2, i, s, o, _) {
    this.oi = e, this.$o = n, this.Uo = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.Wo = 0, this.Go = null, this.zo = null, this.stream = null, this.jo = new __PRIVATE_ExponentialBackoff(e, t);
  }
  Ho() {
...
class __PRIVATE_OnlineStateTracker {
  constructor(e, t) {
    this.asyncQueue = e, this.onlineStateHandler = t, this.state = "Unknown", this.m_ = 0, this.f_ = null, this.g_ = true;
  }
  p_() {
  ...
  set(e) {
    this.b_(), this.m_ = 0, "Online" === e && (this.g_ = false), this.y_(e);
  }
  y_(e) {
...
class __PRIVATE_RemoteStoreImpl {
  constructor(e, t, n, r2, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.D_ = [], this.C_ = /* @__PURE__ */ new Map(), this.v_ = /* @__PURE__ */ new Set(), this.F_ = [], this.M_ = i, this.M_.io((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          t2.v_.add(4), await __PRIVATE_disableNetworkInternal(t2), t2.x_.set("Unknown"), t2.v_.delete(4), await __PRIVATE_enableNetworkInternal(t2);
        }(this));
      });
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.C_.delete(t), r2.Jo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.C_.size && (r2.Jo() ? r2.Xo() : __PRIVATE_canUseNetwork(n) && n.x_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.x_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
    ...
    try {
      ...
      n.compareTo(t2) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        return n2.targetChanges.forEach((n3, r2) => {
          ...
          if (!r2)
            return;
          e2.C_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e2, t4);
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).P_ && await async function __PRIVATE_handleWriteError(e2, t2) {
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.v_.add(3), await __PRIVATE_disableNetworkInternal(n), r2 && n.x_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.v_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
...
function __PRIVATE_ensureWatchStream(e) {
  return e.N_ || (e.N_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
...
function __PRIVATE_ensureWriteStream(e) {
  return e.B_ || (e.B_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  if (n.queries.set(r2, s), s.listeners.push(t), t.K_(n.onlineState), s.q_) {
...
class __PRIVATE_QueryListener {
  constructor(e, t, n) {
    this.query = e, this.W_ = t, this.G_ = false, this.z_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  U_(e) {
...
class __PRIVATE_View {
  constructor(e, t) {
    this.query = e, this.sa = t, this.oa = null, this.hasCachedResults = false, this.current = false, this._a = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.aa = __PRIVATE_newQueryComparator(e), this.ua = new DocumentSet(this.aa);
  }
  get ca() {
    return this.sa;
  }
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P2 = true, (_ && this.aa(c, _) > 0 || a && this.aa(c, a) < 0) && (o = true));
      } else
        !u && c ? (n.track({
          type: 0,
          doc: c
  ...
  da(e) {
    return !this.sa.has(e) && (!!this.ua.has(e) && !this.ua.get(e).hasLocalMutations);
  }
  Ia(e) {
...
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.ma = {}, this.fa = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.ga = /* @__PURE__ */ new Map(), this.pa = /* @__PURE__ */ new Set(), this.ya = new SortedMap(DocumentKey.comparator), this.wa = /* @__PURE__ */ new Map(), this.Sa = new __PRIVATE_ReferenceSet(), this.ba = {}, this.Da = /* @__PURE__ */ new Map(), this.Ca = __PRIVATE_TargetIdGenerator.Bn(), this.onlineState = "Unknown", this.va = void 0;
  }
  get isPrimaryClient() {
    return true === this.va;
  }
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      r2 && (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.Va = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.Va) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.Va), r2.Va = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    await __PRIVATE_syncEngineApplyRemoteEvent(r2, i2), r2.ya = r2.ya.remove(s), r2.wa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.ga.delete(t), e.isPrimaryClient) {
    e.Sa.Vr(t).forEach((t2) => {
      e.Sa.containsKey(t2) || __PRIVATE_removeLimboTarget(e, t2);
    });
  }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.Sa.containsKey(r2.key) || __PRIVATE_removeLimboTarget(e, r2.key);
    } else
      fail();
}
...
class __PRIVATE_AsyncQueueImpl {
  constructor() {
    this.Ya = Promise.resolve(), this.Za = [], this.Xa = false, this.eu = [], this.tu = null, this.nu = false, this.ru = false, this.iu = [], this.jo = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.su = () => {
  ...
  async au() {
    if (0 !== this.Za.length) {
      ...
      this.Za.length > 0 && this.jo.qo(() => this.au());
    }
  }
  _u(e) {
  ...
  enqueueAfterDelay(e, t, n) {
    this.ou(), this.iu.indexOf(e) > -1 && (t = 0);
...
class __PRIVATE_ParseContextImpl {
  constructor(e, t, n, r2, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r2, void 0 === i && this.Iu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w, "4.3.0", e), registerVersion(w, "4.3.0", "esm2017");
}();
...
function login() {
  ...
  logo2.setAttribute("src", colectiveIsCool);
  logo2.setAttribute("alt", "Colective_isCool");
  logo2.setAttribute("id", "logo");
  const section = document.createElement("section");
  const titleLogin = document.createElement("h2");
  titleLogin.textContent = "Inicio de sesi\xF3n";
  ...
  passwordInput.setAttribute("placeholder", "Contrase\xF1a");
  passwordInput.setAttribute("id", "passwordInput");
  passwordInput.setAttribute("name", "passwordInput");
  const signUpLink = document.createElement("a");
  signUpLink.textContent = "Registrarse";
  signUpLink.setAttribute("href", "/newUser");
  signUpLink.classList.add("sign-up");
  const forgotPasswordLink = document.createElement("a");
  forgotPasswordLink.textContent = "\xBFOlvidaste tu contrase\xF1a?";
  forgotPasswordLink.setAttribute("href", "/recover");
  ...
  function autenticacionUser(email, password) {
    return new Promise((resolve, reject) => {
      ...
      signInWithEmailAndPassword(Auth, email, password).then(() => {
        ...
        reject(`Error al iniciar sesion: ${error2.message}`);
      });
    });
  }
  ...
  loginButton.addEventListener("click", () => {
    const email = emailInput.value;
    const password = passwordInput.value;
    autenticacionUser(email, password).then((successMessage) => {
  ...
  btnShowPass.setAttribute("style", `background-image: url(${shutEye})`);
  ...
  btnShowPass.addEventListener("click", () => {
    if (passwordVisible) {
      ...
      btnShowPass.setAttribute("style", `background-image: url(${openEye})`);
    }
  ...
  googleSignInLink.setAttribute("src", darkGoogle);
  ...
  googleSignInLink.addEventListener("click", (e) => {
    ...
    signInWithPopup(auth2, provider).then((result) => {
      ...
      console.error("Error al iniciar sesion con Google:", error2);
    });
  });
  section.append(
    logo2,
...
function error() {
  ...
  title2.textContent = "P\xE1gina no encontrada";
  section.append(errorImage, title, title2);
  return section;
}
const logo256 = "/assets/logo256.b55899f5.png";
const auth = getAuth(firebaseApp);
function recover() {
  const logo2 = document.createElement("img");
  logo2.setAttribute("src", logo256);
  logo2.setAttribute("class", "logoRecover");
  const section = document.createElement("section");
  const title = document.createElement("h2");
  title.textContent = "Recuperar contrase\xF1a";
  ...
  emailRecover.setAttribute("placeholder", "Correo electr\xF3nico");
  ...
  btnSendEmail.addEventListener("click", () => {
    ...
    sendPasswordResetEmail(auth, email).then(() => {
      showAlert.innerHTML = "Correo electr\xF3nico enviado, por favor revisa tu correo para cambiar tu contrase\xF1a";
      setTimeout(() => {
        window.location.href = "/";
      }, 5e3);
    }).catch(() => {
      showAlert.innerHTML = "Correo electr\xF3nico no encontrado";
    });
  });
  section.append(logo2, title, emailRecover, btnSendEmail, showAlert);
  return section;
}
const logo = "/assets/logo.50afe2a5.png";
function newUser() {
  ...
  newUserForm.innerHTML = `<img id="logo" src= "${logo}">
   <h2 id="title">Nuevos usuarios</h2>
    <form id="newUserUl">
        ...
        <li><input id="password" type=password placeholder="Contrase\xF1a" required> 
          <button id="btnEye1" class="eye"></button></li>
        <li><input id="repeatPass" type=password placeholder="Repetir contrase\xF1a" required>
  ...
  registerForm.addEventListener("submit", (event) => {
    ...
    if (password.length <= 8) {
      alert("Prueba con una contrase\xF1a mas larga");
      return;
    }
    const userEmail = email;
    const userPassword = password;
    const auth2 = getAuth();
    createUserWithEmailAndPassword(auth2, userEmail, userPassword).then((userCredential) => {
...
const teacher = "/assets/teacher.cb56fa98.png";
const books = "/assets/books.370202e0.png";
const creativity = "/assets/creativity.86fe0ef6.png";
const inspiration = "/assets/inspiration.eff174e7.png";
const userImage = document.createElement("img");
function preferences() {
  const prefer = document.createElement("section");
  prefer.innerHTML = `<div id="nameInputDiv">
    <h2><label for="userName">\xBFC\xF3mo te llaman?</label></h2>
    ...
    <article id="userType">
      <ul id="pref">
        ...
        <li class="liPref"><button id="creative" value="creator" class="ask" name="userType" data-image="img/creativity.png">
          ...
          <p class="options">Solo vengo por inspiraci\xF3n</button></li>
  ...
  savePreferencesButton.addEventListener("click", () => {
    ...
    if (user) {
      ...
      return setDoc(doc(usuariosCollection, userId), nuevoUsuario).then(() => {
        window.location.href = "./timeLine";
      }).catch((error2) => {
      });
    }
...
function eliminarPost(docID, callback) {
  console.log('DEBUG: Antes de la l\xEDnea if (callback && typeof callback === "function")');
  const postRef = doc(db, "dataBase2", docID);
  return deleteDoc(postRef).then(() => {
    ...
    const mensajeError = `Error al eliminar el post: ${error2.message}`;
    if (callback && typeof callback === "function") {
...
const like = "/assets/like.5689d0a4.png";
const unlike = "/assets/unlike.6286092e.png";
const selectedUserName = localStorage.getItem("selectedUserName");
function postCreate(userImage2, userName, numberLikes, postText, idPost, isLiking) {
  let isLike = isLiking;
  ...
  imgUser.setAttribute("src", userImage2);
  ...
  deleteLink.addEventListener("click", () => {
    if (selectedUserName === userName) {
      const shouldDelete = window.confirm("\xBFEst\xE1s seguro de que deseas borrar este comentario?");
      if (shouldDelete) {
        postId = liPost.id;
        eliminarPost(postId).then(() => {
          liPost.remove();
        }).catch((error2) => {
        });
      }
...
function getPost() {
  ...
  return getDocs(postRef).then((snapshot) => {
    const olderPosts = snapshot.docs.sort((a, b2) => b2.data().time - a.data().time).map((doc2) => ({
      id: doc2.id,
      ...doc2.data()
    }));
    return olderPosts;
...
const logoClose = "/assets/close.c137e129.png";
getAuth(firebaseApp);
function TimeLine() {
  const section = document.createElement("section");
  ...
  commentInput.setAttribute("placeholder", "\xBFQu\xE9 compartes hoy?");
  ...
  if (selectedImage) {
    ...
    userImage2.setAttribute("id", "userImage");
    userImage2.setAttribute("class", "user-image");
    userImage2.setAttribute("src", selectedImage);
    userContainer.appendChild(userImage2);
  }
  const selectedUserName2 = localStorage.getItem("selectedUserName");
  if (selectedUserName2) {
    const userNameElement = document.createElement("p");
    userNameElement.textContent = selectedUserName2;
    userNameElement.setAttribute("class", "user-name");
    userContainer.appendChild(userNameElement);
  }
  sendButton.addEventListener("click", () => {
    const commentText = commentInput.value;
    savePost(selectedUserName2, selectedImage, commentText);
    const likes2 = 0;
    const postLi = postCreate(selectedImage, selectedUserName2, likes2, commentText);
  ...
  window.addEventListener("DOMContentLoaded", () => {
    getPost().then((olderPosts) => {
      olderPosts.forEach((oldPost) => {
        ...
        const isLiking = whoLikes.some((user) => user === selectedUserName2);
